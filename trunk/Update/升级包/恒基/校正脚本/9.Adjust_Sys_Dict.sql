...
--描述: 系统字典表校正脚本,用于配置黑河恒基销售系统的运行环境.
...
--系统有效期
Insert Into Sys_Dict(D_Name,D_Desc,D_Value,D_Memo,D_ParamB) Values('SysParam','系统有效期','2012-04-20','SysValidDate', '29210e8506cb8c0ae235bfbd9b7bc29c')

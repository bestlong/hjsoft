...
--系统有效期
Insert Into Sys_Dict(D_Name,D_Desc,D_Value,D_Memo,D_ParamB) Values('SysParam','系统有效期','2015-01-05','SysValidDate', '74b3059556b7aca3c9c0f41c0b84ce27')
...
insert   Sys_Dict(D_Name,D_Desc,D_Value,D_Memo,D_ParamA,D_ParamB,D_Index)   values( 'StockItem'       ,    '水泥类型'                           ,    '散装_粉煤灰'                                           ,    'S'                    ,    NULL              ,    '+NF'                                                ,    57          )
insert   Sys_Dict(D_Name,D_Desc,D_Value,D_Memo,D_ParamA,D_ParamB,D_Index)   values( 'StockItem'       ,    '水泥类型'                           ,    '散装_阀门道渣'                                         ,    'S'                    ,    NULL              ,    '+NF'                                                ,    57          )

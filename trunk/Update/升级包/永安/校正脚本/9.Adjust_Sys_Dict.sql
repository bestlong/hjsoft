...
--描述: 系统字典表校正脚本,用于配置巩义永安销售系统的运行环境.
...
--系统有效期
Insert Into Sys_Dict(D_Name,D_Desc,D_Value,D_Memo,D_ParamB) Values('SysParam','系统有效期','2012-07-10','SysValidDate', '279c17e4cb995753221d36e8c707a2ef')
...
--添加新的水泥品种
insert   Sys_Dict(D_Name,D_Desc,D_Value,D_Memo,D_ParamA,D_ParamB,D_Index)   values( 'StockItem'       ,    '水泥类型'                           ,    '散装_熟料'                                              ,    'S'                    ,    NULL              ,    '-NF'                                                ,    0           )
...
insert   Sys_Dict(D_Name,D_Desc,D_Value,D_Memo,D_ParamA,D_ParamB,D_Index)   values( 'StockItem'       ,    '水泥类型'                           ,    '散装_复合32.5R'                                         ,    'S'                    ,    NULL              ,    NULL                                                 ,    0           )
insert   Sys_Dict(D_Name,D_Desc,D_Value,D_Memo,D_ParamA,D_ParamB,D_Index)   values( 'StockItem'       ,    '水泥类型'                           ,    '袋装_复合32.5R'                                         ,    'D'                    ,    NULL              ,    NULL                                                 ,    0           )
...
insert   Sys_Dict(D_Name,D_Desc,D_Value,D_Memo,D_ParamA,D_ParamB,D_Index)   values( 'StockItem'       ,    '水泥类型'                           ,    '散装_吨散42.5'                                          ,    'S'                    ,    NULL              ,    NULL                                                 ,    0           )
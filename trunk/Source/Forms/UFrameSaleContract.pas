...
{$R *.dfm}
uses
  ULibFun, UMgrControl, USysConst, USysDB, UDataModule, UFrameBase, UFormBase,
  UFormSaleContract;
...
begin
  Result := 'Select * From (' +
            'Select con.*,sm.S_Name,sm.S_PY,cus.C_Name as Cus_Name,' +
...
begin
  ...
  begin
    ...
    FWhere := 'C_PY like ''%%%s%%'' Or Cus_Name like ''%%%s%%''';

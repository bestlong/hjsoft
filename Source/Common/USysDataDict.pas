...
var nFooter: TDictGroupFooter;
    ...
    var nSummary: TcxGridTableSummaryItem;
        nDBSummary: TcxGridDBTableSummaryItem;
    begin
      ...
      if nSItem is TcxGridTableSummaryItem then
      begin
        nSummary := nSItem as TcxGridTableSummaryItem;
        nSummary.Column := nColumn;
        nSummary.DisplayText := nItem.FFooter.FDisplay;
      end else

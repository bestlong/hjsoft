...
begin
  ...
  try
    ...
    begin
      ...
      begin
        nTunnel.FHasDone := StrToInt(nTmp);
        New(nSync);
...
begin
  ...
  try
    ...
    StrPCopy(@nPTunnel.FTruck, Copy(nTruck, Length(nTruck) - 2, 3));
...
begin
  Result := SetTunnelData(nCOMPort, nTunnel, 0, '', 0, nHint);
end;
